...
public class RoomExit : MonoBehaviour
{
    ...
    public void EnterPortal()
    {
        ...
        // Snapshot passives/inventory/currency/health before the scene unloads — RunStatePlayerLink
        // on the new scene's Player reapplies this once it's initialized — and write the same
        // snapshot to disk. The saved scene is the destination, so quitting here and hitting
        // Continue resumes at the start of the stage the player was walking into.
        RunSaveSerializer.CaptureAndWrite(nextSceneName);
